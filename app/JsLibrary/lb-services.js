...
var urlBase = "https://admin.mapstrack.com/api";
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.AdminEmail#sendOrder
         * @methodOf lbServices.AdminEmail
         *
         * @description
         *
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Customer.facebookAccessToken.update() instead.
        "prototype$__update__facebookAccessToken": {
          url: urlBase + "/Customers/:id/facebookAccessToken",
          method: "PUT"
        },

        // INTERNAL. Use Customer.facebookAccessToken.destroy() instead.
        "prototype$__destroy__facebookAccessToken": {
          url: urlBase + "/Customers/:id/facebookAccessToken",
          method: "DELETE"
        },

        // INTERNAL. Use Customer.track.findById() instead.
        "prototype$__findById__track": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/track/:fk",
          method: "GET"
        },

        // INTERNAL. Use Customer.track.destroyById() instead.
        ...
        // INTERNAL. Use Customer.track.updateById() instead.
        ...
        // INTERNAL. Use Customer.lastUpdatedLocations() instead.
        "prototype$__get__lastUpdatedLocations": {
          url: urlBase + "/Customers/:id/lastUpdatedLocations",
          method: "GET"
        },

        // INTERNAL. Use Customer.lastUpdatedLocations.create() instead.
        "prototype$__create__lastUpdatedLocations": {
          url: urlBase + "/Customers/:id/lastUpdatedLocations",
          method: "POST"
        },

        // INTERNAL. Use Customer.lastUpdatedLocations.update() instead.
        "prototype$__update__lastUpdatedLocations": {
          url: urlBase + "/Customers/:id/lastUpdatedLocations",
          method: "PUT"
        },

        // INTERNAL. Use Customer.lastUpdatedLocations.destroy() instead.
        "prototype$__destroy__lastUpdatedLocations": {
          url: urlBase + "/Customers/:id/lastUpdatedLocations",
          method: "DELETE"
        },
        ...
        // INTERNAL. Use Customer.track() instead.
        "prototype$__get__track": {
          isArray: true,
          url: urlBase + "/Customers/:id/track",
          method: "GET"
        },

        // INTERNAL. Use Customer.track.create() instead.
        "prototype$__create__track": {
          url: urlBase + "/Customers/:id/track",
          method: "POST"
        },

        // INTERNAL. Use Customer.track.destroyAll() instead.
        "prototype$__delete__track": {
          url: urlBase + "/Customers/:id/track",
          method: "DELETE"
        },

        // INTERNAL. Use Customer.track.count() instead.
        "prototype$__count__track": {
          url: urlBase + "/Customers/:id/track/count",
          method: "GET"
        },
         ...
         * @description
         *
         * Request code for OTP verification of  Mapstrack App
         *
         * @param {Object=} parameters Request parameters.
         *
         *   This method does not accept any parameters.
         ...
         * @description
         *
         * Customer login by OTP verification of  Mapstrack App
         *
         * @param {Object=} parameters Request parameters.
         *
         *   This method does not accept any parameters.
        ...
        /**
         * @ngdoc method
         * @name lbServices.Customer#search
         * @methodOf lbServices.Customer
         *
         * @description
         *
         * Customer find by post method
         *
         * @param {Object=} parameters Request parameters.
         *
         *   This method does not accept any parameters.
        ...
        "search": {
          isArray: true,
          url: urlBase + "/Customers/search",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Customer#sendAppLink
         * @methodOf lbServices.Customer
         *
         * @description
         *
         * Share android download link through sms.
         *
         * @param {Object=} parameters Request parameters.
         *
         *   This method does not accept any parameters.
         ...
         */
        "sendAppLink": {
          url: urlBase + "/Customers/sendAppLink",
          method: "POST"
        },
         ...
         * @description
         *
         * Logins a user by authenticating it with an external entity
         *
         * @param {Object=} parameters Request parameters.
         *
         *   This method does not accept any parameters.
        ...
        // INTERNAL. Use Track.customer() instead.
        "::get::Track::customer": {
          url: urlBase + "/Tracks/:id/customer",
          method: "GET"
        },

        // INTERNAL. Use LastUpdatedLocation.customer() instead.
        "::get::LastUpdatedLocation::customer": {
          url: urlBase + "/LastUpdatedLocations/:id/customer",
          method: "GET"
        },
    ...
    */
     ...
     */
         ...
         * @description
         *
         * Fetches hasOne relation facebookAccessToken.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        /**
         * @ngdoc method
         * @name lbServices.Customer.facebookAccessToken#destroy
         * @methodOf lbServices.Customer.facebookAccessToken
         *
         * @description
         *
         * Deletes facebookAccessToken of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * This method returns no data.
         */
        R.facebookAccessToken.destroy = function() {
          var TargetResource = $injector.get("FacebookAccessToken");
          var action = TargetResource["::destroy::Customer::facebookAccessToken"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.facebookAccessToken#update
         * @methodOf lbServices.Customer.facebookAccessToken
         *
         * @description
         *
         * Update facebookAccessToken of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.facebookAccessToken.update = function() {
          var TargetResource = $injector.get("FacebookAccessToken");
          var action = TargetResource["::update::Customer::facebookAccessToken"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Customer.track
     * @header lbServices.Customer.track
     * @object
     * @description
     *
     * The object `Customer.track` groups methods
     * manipulating `Track` instances related to `Customer`.
     *
     * Call {@link lbServices.Customer#track Customer.track()}
     * to query all related instances.
     */
        ...
        R.track = function() {
          ...
          var action = TargetResource["::get::Customer::track"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.track#count
         * @methodOf lbServices.Customer.track
         *
         * @description
         *
         * Counts track of Customer.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        R.track.count = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::count::Customer::track"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.track#create
         * @methodOf lbServices.Customer.track
         *
         * @description
         *
        ...
        R.track.create = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::create::Customer::track"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.track#createMany
         * @methodOf lbServices.Customer.track
         *
         * @description
         *
        ...
        R.track.createMany = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::createMany::Customer::track"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.track#destroyAll
         * @methodOf lbServices.Customer.track
         *
         * @description
         *
        ...
        R.track.destroyAll = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::delete::Customer::track"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.track#destroyById
         * @methodOf lbServices.Customer.track
         *
         * @description
         *
        ...
        R.track.destroyById = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::destroyById::Customer::track"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.track#findById
         * @methodOf lbServices.Customer.track
         *
         * @description
         *
        ...
        R.track.findById = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::findById::Customer::track"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.track#updateById
         * @methodOf lbServices.Customer.track
         *
         * @description
         *
        ...
        R.track.updateById = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::updateById::Customer::track"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Customer.lastUpdatedLocations
     * @header lbServices.Customer.lastUpdatedLocations
     * @object
     * @description
     *
     * The object `Customer.lastUpdatedLocations` groups methods
     * manipulating `LastUpdatedLocation` instances related to `Customer`.
     *
     * Call {@link lbServices.Customer#lastUpdatedLocations Customer.lastUpdatedLocations()}
     * to query all related instances.
     */
         ...
         * @description
         *
         * Fetches hasOne relation lastUpdatedLocations.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `LastUpdatedLocation` object.)
         * </em>
         */
        R.lastUpdatedLocations = function() {
          var TargetResource = $injector.get("LastUpdatedLocation");
          var action = TargetResource["::get::Customer::lastUpdatedLocations"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.lastUpdatedLocations#create
         * @methodOf lbServices.Customer.lastUpdatedLocations
         *
         * @description
         *
         * Creates a new instance in lastUpdatedLocations of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.lastUpdatedLocations.create = function() {
          var TargetResource = $injector.get("LastUpdatedLocation");
          var action = TargetResource["::create::Customer::lastUpdatedLocations"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.lastUpdatedLocations#createMany
         * @methodOf lbServices.Customer.lastUpdatedLocations
         *
         * @description
         *
         ...
         * </em>
         */
        R.lastUpdatedLocations.createMany = function() {
          var TargetResource = $injector.get("LastUpdatedLocation");
          var action = TargetResource["::createMany::Customer::lastUpdatedLocations"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.lastUpdatedLocations#destroy
         * @methodOf lbServices.Customer.lastUpdatedLocations
         *
         * @description
         *
         * Deletes lastUpdatedLocations of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * This method returns no data.
         */
        R.lastUpdatedLocations.destroy = function() {
          var TargetResource = $injector.get("LastUpdatedLocation");
          var action = TargetResource["::destroy::Customer::lastUpdatedLocations"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.lastUpdatedLocations#update
         * @methodOf lbServices.Customer.lastUpdatedLocations
         *
         * @description
         *
         * Update lastUpdatedLocations of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.lastUpdatedLocations.update = function() {
          var TargetResource = $injector.get("LastUpdatedLocation");
          var action = TargetResource["::update::Customer::lastUpdatedLocations"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Customer.facebookAccessToken.update() instead.
        "::update::Customer::facebookAccessToken": {
          url: urlBase + "/Customers/:id/facebookAccessToken",
          method: "PUT"
        },

        // INTERNAL. Use Customer.facebookAccessToken.destroy() instead.
        "::destroy::Customer::facebookAccessToken": {
          url: urlBase + "/Customers/:id/facebookAccessToken",
          method: "DELETE"
        },
      }
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Track.eventType() instead.
        "prototype$__get__eventType": {
          url: urlBase + "/Tracks/:id/eventType",
          method: "GET"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Track#getSchema
         * @methodOf lbServices.Track
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Track#getAbsoluteSchema
         * @methodOf lbServices.Track
         *
         * @description
         *
        ...
        // INTERNAL. Use Customer.track.create() instead.
        "::create::Customer::track": {
          url: urlBase + "/Customers/:id/track",
          method: "POST"
        },

        // INTERNAL. Use Customer.track.createMany() instead.
        "::createMany::Customer::track": {
          isArray: true,
          url: urlBase + "/Customers/:id/track",
          method: "POST"
        },
        ...
        // INTERNAL. Use Customer.track.destroyAll() instead.
        "::delete::Customer::track": {
          url: urlBase + "/Customers/:id/track",
          method: "DELETE"
        },

        // INTERNAL. Use Customer.track.count() instead.
        "::count::Customer::track": {
          url: urlBase + "/Customers/:id/track/count",
          method: "GET"
        },

        // INTERNAL. Use EventType.tracks.findById() instead.
        "::findById::EventType::tracks": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/EventTypes/:id/tracks/:fk",
          method: "GET"
        },

        // INTERNAL. Use EventType.tracks.destroyById() instead.
        "::destroyById::EventType::tracks": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/EventTypes/:id/tracks/:fk",
        ...
        // INTERNAL. Use EventType.tracks.updateById() instead.
        "::updateById::EventType::tracks": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/EventTypes/:id/tracks/:fk",
        ...
        // INTERNAL. Use EventType.tracks() instead.
        "::get::EventType::tracks": {
          isArray: true,
          url: urlBase + "/EventTypes/:id/tracks",
          method: "GET"
        },

        // INTERNAL. Use EventType.tracks.create() instead.
        "::create::EventType::tracks": {
          url: urlBase + "/EventTypes/:id/tracks",
          method: "POST"
        },

        // INTERNAL. Use EventType.tracks.createMany() instead.
        "::createMany::EventType::tracks": {
          isArray: true,
          url: urlBase + "/EventTypes/:id/tracks",
          method: "POST"
        },

        // INTERNAL. Use EventType.tracks.destroyAll() instead.
        "::delete::EventType::tracks": {
          url: urlBase + "/EventTypes/:id/tracks",
          method: "DELETE"
        },

        // INTERNAL. Use EventType.tracks.count() instead.
        "::count::EventType::tracks": {
          url: urlBase + "/EventTypes/:id/tracks/count",
          method: "GET"
        },
      }
    );
    ...
    */
    R.modelName = "Track";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Track#customer
         * @methodOf lbServices.Track
         *
         * @description
         *
        ...
        R.customer = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::get::Track::customer"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Track#eventType
         * @methodOf lbServices.Track
         *
         * @description
         *
         * Fetches belongsTo relation eventType.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.eventType = function() {
          var TargetResource = $injector.get("EventType");
          var action = TargetResource["::get::Track::eventType"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.LastUpdatedLocation
 * @header lbServices.LastUpdatedLocation
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `LastUpdatedLocation` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/LastUpdatedLocations/:id",
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#create
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         */
        "create": {
          url: urlBase + "/LastUpdatedLocations",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#createMany
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#upsert
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#exists
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#findById
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/LastUpdatedLocations/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#find
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#findOne
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/LastUpdatedLocations/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#updateAll
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/LastUpdatedLocations/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#deleteById
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#count
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#prototype$updateAttributes
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#createChangeStream
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#getSchema
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#getAbsoluteSchema
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#save
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        // INTERNAL. Use Customer.lastUpdatedLocations() instead.
        "::get::Customer::lastUpdatedLocations": {
          url: urlBase + "/Customers/:id/lastUpdatedLocations",
          method: "GET"
        },

        // INTERNAL. Use Customer.lastUpdatedLocations.create() instead.
        "::create::Customer::lastUpdatedLocations": {
          url: urlBase + "/Customers/:id/lastUpdatedLocations",
          method: "POST"
        },

        // INTERNAL. Use Customer.lastUpdatedLocations.createMany() instead.
        "::createMany::Customer::lastUpdatedLocations": {
          isArray: true,
          url: urlBase + "/Customers/:id/lastUpdatedLocations",
          method: "POST"
        },
        ...
        // INTERNAL. Use Customer.lastUpdatedLocations.update() instead.
        "::update::Customer::lastUpdatedLocations": {
          url: urlBase + "/Customers/:id/lastUpdatedLocations",
          method: "PUT"
        },

        // INTERNAL. Use Customer.lastUpdatedLocations.destroy() instead.
        "::destroy::Customer::lastUpdatedLocations": {
          url: urlBase + "/Customers/:id/lastUpdatedLocations",
          method: "DELETE"
        },
      }
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#updateOrCreate
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#update
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#destroyById
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#removeById
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.LastUpdatedLocation#modelName
    * @propertyOf lbServices.LastUpdatedLocation
    * @description
    * The name of the model represented by this $resource,
    * i.e. `LastUpdatedLocation`.
    */
    R.modelName = "LastUpdatedLocation";


        /**
         * @ngdoc method
         * @name lbServices.LastUpdatedLocation#customer
         * @methodOf lbServices.LastUpdatedLocation
         *
         * @description
         *
        ...
        R.customer = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::get::LastUpdatedLocation::customer"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.EventType#getSchema
         * @methodOf lbServices.EventType
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EventType#getAbsoluteSchema
         * @methodOf lbServices.EventType
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.EventType#save
         * @methodOf lbServices.EventType
         *
         * @description
         *
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.EventType.tracks
     * @header lbServices.EventType.tracks
     * @object
     * @description
     *
     * The object `EventType.tracks` groups methods
     * manipulating `Track` instances related to `EventType`.
     *
     * Call {@link lbServices.EventType#tracks EventType.tracks()}
     * to query all related instances.
     */
        ...
        R.tracks = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::get::EventType::tracks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.EventType.tracks#count
         * @methodOf lbServices.EventType.tracks
         *
         * @description
         *
         * Counts tracks of EventType.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.tracks.count = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::count::EventType::tracks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.EventType.tracks#create
         * @methodOf lbServices.EventType.tracks
         *
         * @description
         *
        ...
        R.tracks.create = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::create::EventType::tracks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.EventType.tracks#createMany
         * @methodOf lbServices.EventType.tracks
         *
         * @description
         *
        ...
        R.tracks.createMany = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::createMany::EventType::tracks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.EventType.tracks#destroyAll
         * @methodOf lbServices.EventType.tracks
         *
         * @description
         *
        ...
        R.tracks.destroyAll = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::delete::EventType::tracks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.EventType.tracks#destroyById
         * @methodOf lbServices.EventType.tracks
         *
         * @description
         *
        ...
        R.tracks.destroyById = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::destroyById::EventType::tracks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.EventType.tracks#findById
         * @methodOf lbServices.EventType.tracks
         *
         * @description
         *
        ...
        R.tracks.findById = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::findById::EventType::tracks"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.EventType.tracks#updateById
         * @methodOf lbServices.EventType.tracks
         *
         * @description
         *
        ...
        R.tracks.updateById = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::updateById::EventType::tracks"];
          return action.apply(R, arguments);
        };
